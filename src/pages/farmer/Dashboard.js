...
const FarmerDashboard = () => {
  ...
  const [recentOrders, setRecentOrders] = useState([
    ...
    },
    {
      ...
      deliveryAddress: { pincode: '560034' }
    },
    {
      _id: '3',
      orderId: 'FB-2026-003',
      ...
      deliveryAddress: { pincode: '560095' }
    }
  ]);

  const menuItems = [
    { icon: Package, label: t('myProducts'), path: '/farmer/products' },
            ...
            <div className="bg-white rounded-xl shadow p-6">
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between p-3 bg-green-50 rounded-lg">
                  ...
                  <span className="px-2 py-1 bg-green-100 text-green-800 rounded-full text-xs font-medium">Premium</span>
                </div>
                <div className="flex items-center justify-between p-3 bg-yellow-50 rounded-lg">
                  ...
                  <span className="px-2 py-1 bg-yellow-100 text-yellow-800 rounded-full text-xs font-medium">Standard</span>
                </div>
                <div className="flex items-center justify-between p-3 bg-red-50 rounded-lg">
                  ...
                  <span className="px-2 py-1 bg-red-100 text-red-800 rounded-full text-xs font-medium">Reject</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow p-6">
              ...
              <div className="space-y-3">
                ...
                <div className="p-3 bg-yellow-50 rounded-lg">
                  <div className="flex items-center justify-between mb-2">
                    <span className="font-medium">Mangoes</span>
